...
\begin{frame}{Cherenkov angle vs particle momentum}
  \begin{figure}
    ...
    \caption{The Cherenkov angle as a function of a particles momentum for specific refactive indices.}
  \end{figure}
\end{frame}
...
\begin{frame}{Reconstruction of the orginial direction of a particle}
  ...
  \begin{figure}
    ...
    \caption{Reconstruction of the original direction of the gamma particle.}
  \end{figure}
\end{frame}
...
%By Reculet - made this diagram using ProFit on a MacPreviously published: not published, CC BY-SA 3.0, https://en.wikipedia.org/w/index.php?curid=37764289
%\end{frame}
